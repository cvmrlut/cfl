...
echo ''
echo -e "图形UI：Clash Dashboard 访问 http://<ip>:9090/ui"
echo -e "Secret: ${Secret}"
echo -e "终端Cli：`scripts/clash_proxy-selector.sh`（使用脚本前，需要修改脚本中的 **Secret** 变量值为上述启动脚本输出的值，或与 `.env` 中定义的 **CLASH_SECRET** 变量值保持一致）"
echo ''
